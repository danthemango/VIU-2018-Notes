...
int main(void) {
   ...
   while(1) {
      ...
      for (i = 0; i < numtasks; ++i) {
         // run task if queued and deadline not passed
         if(DEBUG){
         ...
         // otherwise queue uncompleted task
...
// calls TimerISR every 'cycleTime' milliseconds
// after a TimerOn() call
void TimerSet(unsigned long cycleTime){
